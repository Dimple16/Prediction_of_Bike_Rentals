 ...
 setBackgroundImage(src = 'topimage'),
  sidebarLayout(
    ...
    sidebarPanel(
     ...
     img(src='sideimage.png', align = "center",height = 200, width = 350),
    ...
    mainPanel(
	 img(src="topimage.jpg", height = 100, width = 850),
	  tags$head(
  ...
  tabsetPanel(type = "tabs",
				  ...
				  tabPanel("Comparison", verbatimTextOutput("tab1"),verbatimTextOutput("tab2"),verbatimTextOutput("tab3"),verbatimTextOutput("tab4"),verbatimTextOutput("tab5"),verbatimTextOutput("tab6"),verbatimTextOutput("tab7"),verbatimTextOutput("tab8"),verbatimTextOutput("tab9"),verbatimTextOutput("tab10"))				
...
setwd("C:/Users/DEV/Desktop/Final Year Project/Project Demo/bikeRentPrediction-master") #give the location of test data set
